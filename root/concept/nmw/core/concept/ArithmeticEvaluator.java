...
public class ArithmeticEvaluator {
    ...
    private static void formEquation(Set<String[]> operands, Set<String[]> expressions)
        ...
        for (String[] o : operands) {
            ...
            for (String[] e : expressions) {
                ...
                System.out.println(
                        "EQUATION [" + equation + "] = " + result /*+ " TYPE = " + result.getClass()*/);
            }
        }
    }
  ...
  public static void print(List<char[]> input) {
    ...
    public static void printx(Set<?> input) {

        List<String[]> sorted = new ArrayList<String[]>((Set<String[]>)input);
  ...
  public static void  printInt(Set<int[]> input) {
